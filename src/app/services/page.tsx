...
const services = [
  ...
  { id: 'business-apis', title: 'Business APIs', description: 'Powerful APIs for data conversion, accounting, inventory management and business automation.', icon: '💼', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop', href: '/services/business', category: 'business', features: ['Data↔Spreadsheet API', 'Accounting Integration', 'Inventory Management', 'Business Automation'], whiteLabel: true },
  { id: 'business-audit', title: 'Business Auditing', description: 'Comprehensive business scoring — SEO analysis, Google Maps profile verification, website quality audits.', icon: '🔍', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&h=400&fit=crop', href: '/services/audit', category: 'audit', features: ['SEO Score Analysis', 'Google Maps Profile Check', 'Website Quality Audit', 'Social Presence Score'], whiteLabel: true },
  { id: 'web-dev', title: 'Website Development', description: 'Build new websites for businesses without one, or optimize and refine existing websites.', icon: '🌐', image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=600&h=400&fit=crop', href: '/services/web-dev', category: 'web-dev', features: ['New Website Build', 'Website Optimization', 'SEO Enhancement', 'Performance Tuning'], whiteLabel: true },
  { id: 'ai-agents', title: 'AI Digital Employees', description: 'Unlimited trained agents for your business — flat $5K/mo. Revenue-focused, not time-saving. 48-hour deployment.', icon: '🤖', image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=600&h=400&fit=crop', href: '/services/ai', category: 'ai', features: ['Unlimited agents', 'Unlimited usage', 'Unlimited support', '48hr deployment'], whiteLabel: true },
