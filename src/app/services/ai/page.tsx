    ...
    <div className="bg-surface-0">
      ...
      <Section>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <Badge variant="sunset">AI Digital Employees</Badge>
            <h1 className="text-4xl sm:text-6xl font-bold text-white mt-4 mb-6 leading-tight">
              Hire a Digital Employee
              <br />
              <GradientText>That Knows Your Business</GradientText>
            </h1>
            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
              Not a chatbot. Not a copilot. A trained agent that learns your operations, handles repetitive work, and gets smarter every week — on a flat monthly fee.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Button href="#offer" size="lg">See Unlimited Offer</Button>
              <Button href="#demo" variant="outline" size="lg">Watch Demo</Button>
            </div>
