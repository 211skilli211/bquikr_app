...
const apiServices = [
  ...
  },
  {
    ...
    description: 'Convert between Caribbean and world currencies with live rates',
  ...
  },
  {
    ...
    description: 'Discover festivals, concerts, sports, and cultural events across the Caribbean',
